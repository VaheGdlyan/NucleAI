/**
 * The Grid — math & story engine (framework-agnostic).
 * Shared by index.html (ES module) and GridSimulator.jsx — edit here only.
 */

export function calculateStability(nuclear, solar, hydro, fossil) {
...
export function calculateCO2(nuclear, solar, hydro, fossil) {
...
export function calculateCost(nuclear, solar, hydro, fossil, stability) {
  let cost =
...
export function calculateGridMetrics(nuclear, solar, hydro = 0) {
...
export function isOptimalMix(nuclear, solar, hydro, fossil, stability, co2, cost) {
  return (
    nuclear >= 50 &&
    solar >= 25 &&
    solar <= 45 &&
...
export function getGridStoryMessage(
  stability,
  co2,
  cost,
  nuclear,
...
export function getStabilityDisplayState(stability, nuclear, solar) {
...
export function stabilityStatusIcon(state) {
